...
from data_eng_instructions.writer.WorkOrderStatusWriter import WorkOrderStatusWriter
...
class WorkOrderStatusPipeline(Pipeline):
    ...
    def run(self) -> Any:
        print("Extract work order statuses")
        ...
        print("Write work order statuses")
        writer: WorkOrderStatusWriter = WorkOrderStatusWriter(result_df, storage_path())
        self.write_to_storage(writer, "work_order_status")